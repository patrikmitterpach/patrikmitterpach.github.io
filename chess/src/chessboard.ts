...
export enum Color {
  ...
  // Type for a chess board square (can be empty or contain a piece)
  ...
  export class ChessBoard {
    ...
    private initializeBoard(): Square[][] {
      ...
      const board: Square[][] = new Array(8).fill(null).map(() => new Array(8).fill(null));
    ...
    private setupInitialPosition(board: Square[][]): void {
      // Set up pawns
      for (let i = 0; i < 8; i++) {
    ...
    // Other methods for game logic, validations, etc.
  }
